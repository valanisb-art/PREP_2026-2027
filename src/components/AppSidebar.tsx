...
import { LayoutDashboard, List, FileBarChart, Clock, LogOut, Shield, User, Sun, Moon, CalendarDays, ClipboardList, X } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { to: "/proyeccion", label: "PREP 26-27", icon: List },
  { to: "/prep54", label: "PREP (54)", icon: ClipboardList, hideForInvitado: true },
          ...
          .map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.to === "/prep54" && (
                  <span className="ml-auto text-[10px] font-bold px-1.5 py-0.5 rounded bg-primary/20 text-primary border border-primary/30">
                    54
                  </span>
                )}
              </Link>
